...
import 'package:vpn_app/Server/server_screen.dart';
      ...
      drawer: Drawer(
        child: Column(
          children: [
            ...
            ListTile(
              onTap: (){},
              leading: const Icon(Icons.all_inbox_outlined, color: Colors.black),
              title: const Text(
                "About Us",
                style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
              ),
            ...
            Container(
              ...
              child: Center(
                child: Text(
                  ...
                  style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w500, color: secndryColor),
                ),
              ),
            ),
            //Select location
                  ...
                  child: Center(
                    child: Row(
                      ...
                      children: const [
                        Text(
                          "Select Location",
                          style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500, color: secndryColor),
                        ),
                        Icon(Icons.keyboard_arrow_down, color: secndryColor,),
                      ],
                    ),
                  ),
                ),
